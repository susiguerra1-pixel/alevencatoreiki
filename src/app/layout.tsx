    ...
    <html lang="pt-BR" className={`${jost.variable} ${cormorant.variable}`}>
      <head>
        ...
        <Script id="gtm" strategy="afterInteractive">{`
          ...
          })(window,document,'script','dataLayer','GTM-5WQXQCHZ');
        `}</Script>
      </head>
      <body className="antialiased">
        ...
        <noscript>
          ...
          <img height="1" width="1" style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=898871746511357&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-5WQXQCHZ"
            height="0" width="0"
