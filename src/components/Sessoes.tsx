...
const sessions = [
  {
    ...
    paragraphs: [
      "Uma sessão de Reiki completa para relaxar, desacelerar e permitir que o corpo e a mente entrem em estado de equilíbrio.",
      "Ideal para quem deseja conhecer o Reiki ou precisa de um momento de cuidado e pausa.",
    ],
    bullets: ["50 a 60 minutos de duração", "atendimento presencial em Caxias do Sul"],
    cta: "Agendar sessão",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Com o tempo, o corpo aprende a responder melhor — e os efeitos vão além da sessão.",
    ],
    bullets: [],
  ...
  },
  {
    ...
    hook: '"Quero um acompanhamento de verdade, ao longo do tempo."',
    paragraphs: [
      "Um acompanhamento planejado de acordo com o que você está vivendo, com mais atenção ao processo do que à quantidade de sessões.",
      "Indicado para quem quer trabalhar algo específico — estresse crônico, ansiedade, um período difícil — com continuidade e presença.",
    ],
    bullets: [],
...
export default function Sessoes() {
  return (
    <section id="sessoes" className="bg-[#F5F0EB] py-16 md:py-24 px-[6%]">
      <div className="max-w-[1100px] mx-auto">
        ...
        <AnimatedSection>
          <div className="text-center mb-14">
            ...
            <p className="text-[1rem] leading-[1.85] text-[#524848] font-normal max-w-[500px] mx-auto">
              ...
              <div className="bg-[#F3EEF5] p-10 relative overflow-hidden flex flex-col card-hover h-full">
                ...
                {s.featured && (
                  <div className="inline-flex items-center gap-1.5 mb-4 self-start">
                    <span className="text-[0.62rem] tracking-[0.5px] uppercase text-[#4A2E0A] border border-[rgba(184,149,106,0.4)] px-3 py-1 font-light">
                      ⭐ {s.featuredLabel}
                    </span>
                  </div>
                )}
                ...
                <div className="flex flex-col gap-3 text-[1rem] leading-[1.85] text-[#524848] font-normal mb-5 flex-1">
