          ...
          <AnimatedSection>
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-[rgba(184,149,106,0.1)] border border-[rgba(184,149,106,0.25)] px-4 py-2 mb-4 md:mb-6">
                ...
                <span className="text-[0.7rem] tracking-[3px] uppercase text-[#4A2E0A] font-light">
              ...
              <div className="flex flex-col items-start gap-3 md:gap-4">
                ...
                <a
                  href="#sobre"
                  className="btn-secondary-line text-[0.75rem] tracking-[2px] uppercase text-[#4A2E0A] font-light hover:opacity-80 transition-opacity duration-300 flex items-center"
                >
                  Ver como funciona
                </a>
              </div>
