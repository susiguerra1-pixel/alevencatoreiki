    ...
    <div className="relative bg-[#EDE7EF] py-16 md:py-24 px-[6%] text-center overflow-hidden cta-radial">
      <AnimatedSection>
        <div className="relative z-10 max-w-[620px] mx-auto">
          {/* Escassez */}
          <div className="inline-block bg-[rgba(184,149,106,0.2)] border border-[rgba(184,149,106,0.3)] px-5 py-1.5 text-[0.68rem] tracking-[1px] uppercase text-[#4A2E0A] mb-6 font-light">
